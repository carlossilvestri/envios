...
<html xmlns="http://www.w3.org/1999/xhtml" lang="es" xml:lang="es">
	<head>
		<title>Envíos Express - Aviso Legal</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
		<meta name="description" content="Lea atentamente nuestro aviso legal" />    
	...
	<div class="container">
		<div class="header-content">
        	...
        	<a href="#" style="text-decoration:none">
					<h3 class="logo-header"><span class="header-name">Envíos Express | </span><span class="logo-color">Aviso Legal</span></h3>
				</a>		
			</div>
		...
		<section class="c-s section-legal section-subpage-first bg-w-secondary">
            ...
            <p>Reponsable y titular del sitio web: https://envios-express.site - Express Shipments  S.R.L</p>
